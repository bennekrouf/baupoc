...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "bau@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "bau API";

        private String description = "bau API documentation";
